...
def successMail(reqDetails, data):
    if data != False:
        ...
        for i in data:
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align v-line-height"
                                ...
                                <p style="font-size: 14px; line-height: 140%;">Email id: {email}</p>
                                <p style="font-size: 14px; line-height: 140%;">Blood group: {Bgroup}</p>
                                <p style="font-size: 14px; line-height: 140%;">State: {dist}</p>
          ...
          </div><br>'''.format(name=i['NAME'], cnum=i['PHNUM'], Bgroup=i['BLOOD'], dist=i['DISTRICT'], city=i['STATES'], email=i['EMAIL'])
                                ...
                                <tr>
                                    ...
                                    <div class="v-text-align v-line-height"
                                        ...
                                        <p style="font-size: 14px; line-height: 130%;"><span
                                            ...
                                            <strong>We received your request !</strong></span></p>
                                    </div>
                                    </td>
                                </tr>
                                </tbody>
...
def sendEmailToDoanar(name, reqDetails):
    donarMsg =  '''
        <!DOCTYPE HTML
    PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <table
        ...
        <tr style="vertical-align: top">
                    ...
                    <div
                        ...
                        <table id="u_content_text_3" style="font-family:'Open Sans',sans-serif;" role="presentation"
                            ...
                            <tr>
                                ...
                                <div class="v-text-align v-line-height"
                                    ...
                                    <p style="font-size: 14px; line-height: 130%;"><span
                                        style="font-family: Montserrat, sans-serif; font-size: 16px; line-height: 20.8px;">
                                        <strong>We need your Help !</strong></span></p>
                                </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0"
                            ...
                            <tr>
                                ...
                                <div class="v-text-align v-line-height"
                                    style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 140%;">We have an Urgent requiremnet of Plasma for <span
                                        style="text-decoration: underline; font-size: 14px; line-height: 19.6px;"><strong> '''+ reqDetails['bloodgrp']+'''</strong></span>
                                    at <strong> '''+ reqDetails['State']+'''</strong> - <strong> '''+ reqDetails['City']+'''</strong>. Please find the details of the requester and contact them as soon as possible. </p>
                                </div>
                                </td>
                            </tr>
                            </tbody>
            ...
            </div> <div class="u-row-container" style="padding: 0px;background-color: transparent">
        <div class="u-row"
        style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
        <div
            style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
            ...
            <div
                ...
                <table id="u_content_text_11" style="font-family:'Open Sans',sans-serif;" role="presentation"
                    ...
                    <tr>
                        ...
                        <div class="v-text-align v-line-height"
                            style="line-height: 140%; text-align: left; word-wrap: break-word;">
                            <p style="font-size: 14px; line-height: 140%;">Name: '''+ reqDetails['Name']+'''                                     </p>
                            <p style="font-size: 14px; line-height: 140%;">Contact number: '''+ reqDetails['phone']+'''                                          </p>
                            <p style="font-size: 14px; line-height: 140%;">Email id: '''+ reqDetails['Email']+'''                                         </p>
                            <p style="font-size: 14px; line-height: 140%;">Blood group: '''+ reqDetails['bloodgrp']+'''                                         </p>
                            <p style="font-size: 14px; line-height: 140%;">State:'''+ reqDetails['State']+'''                                            </p>
                            <p style="font-size: 14px; line-height: 140%;">City: '''+ reqDetails['City']+'''                                             </p>
                        </div>
                        </td>
                    </tr>
                    </tbody>
